...
import 'package:homedesignadmin/Screens/CommercialREQview.dart';
import 'package:homedesignadmin/Screens/ResidencialReqView.dart';
             ...
             Container(
               ...
               child: InkWell(
                 onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => CommercialREq()),
                    );
                 },
                 child: Stack(
                   children: [
