...
import '../Global.dart';
import 'CommercialMilestoneScreen.dart';
import 'ResidentialMilestoneScreen.dart';
...
class _MileStoneScreenState extends State<MileStoneScreen> {
  ...
  void initState() {
    //fetchRequestUid(_auth.currentUser.uid);
    super.initState();
    fetchApprovalRequestUid();
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ResidentialMilestoneScreen()),
                );
              },
              child: Container(
                height: 230,
            ...
            Container(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CommercialMilestoneScreen()),
                  );
                },
                child: Stack(
                  children: [
